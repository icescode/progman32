...
__published:
    ...
    void __fastcall AppMonitor1Click(TObject *Sender);

private:

    int LastLayoutMode; // 0: None, 1: Cascade, 2: TileV, 3: TileH
    void __fastcall LoadItemsFromGrp(AnsiString FileName);
    TFormGroup* __fastcall FindGroupWindow(AnsiString Caption);
