...
{
    // Update Filter: Menambahkan *.cpl ke dalam daftar
    ...
    if (openDialog->Execute())
    {
        ...
        // Tetap gunakan fungsi format title Anda yang sudah ada
